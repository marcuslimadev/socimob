<?php
/**
 * Endpoint público para executar envio de template Twilio para Marcus André
 * Acesse: https://lojadaesquina.store/exec_template_marcus.php
 * ATENÇÃO: Remover este arquivo após o teste!
 */
...
echo "\n\n⚠️  LEMBRETE: Remova este arquivo após o teste!\n";
echo "rm public/exec_template_marcus.php\n";
