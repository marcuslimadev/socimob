...
return [
    ...
    'graph' => [
        ...
        'version' => env('META_GRAPH_API_VERSION', 'v23.0'),
        ...
        'default_access_token' => env('META_GRAPH_ACCESS_TOKEN'),
        'default_waba_id' => env('META_WABA_ID'),
        'default_business_account_id' => env('META_BUSINESS_ACCOUNT_ID'),
        'default_phone_number_id' => env('META_PHONE_NUMBER_ID'),
    ],
    'webhook' => [
