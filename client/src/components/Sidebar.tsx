...
const Sidebar = () => {
  ...
  const menuItems: SidebarItem[] = [
    ...
    { icon: <Users size={24} />, label: 'Leads', href: '/leads', badge: 12 },
    ...
    <>
      ...
      >
            ...
            return (
              ...
              >
                <motion.div
                  ...
                  className={`relative group flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-300 cursor-pointer ${
                    isActive
        ...
        <div className="flex flex-col gap-2 px-2">
          ...
          <motion.button
            onClick={() => {
              console.log('Logout clicked - Sidebar desktop');
