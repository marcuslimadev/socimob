# 🚀 SOCIMOB - Sistema de Gestão Imobiliária (Servidor Único)

## 🎉 NOVO: Versão Simplificada com Servidor Único PHP

**📌 ATENÇÃO:** O sistema foi consolidado em um **servidor único PHP** para máxima simplicidade!

👉 **Veja o guia completo:** [SERVIDOR_UNICO.md](SERVIDOR_UNICO.md)

### ⚡ Início Rápido (2 Passos)
1. Execute `backend\START.bat` (Windows)
2. Acesse `http://127.0.0.1:8000/app/`

**Login:** `admin@exclusiva.com` / `password`

---

## 📦 O Que Está Incluído

Este pacote contém uma plataforma SaaS multi-tenant completa para gerenciamento de imobiliárias.
